...
export const QUE_HACE: Record<string, string> = {
  ...
  buscar_contacto_emergencia: "Referencia, tipo de sangre, alergias, enfermedades cronicas y NSS. El propio, cualquiera; el de otro, admin con show_cssi",
...
export const VIAS_DIRECTAS = [
  ...
  { pregunta: "«mi contacto de emergencia» / «el de <persona>»", resuelve: "Referencia con teléfono y relación, tipo de sangre, alergias, enfermedades crónicas y NSS" },
