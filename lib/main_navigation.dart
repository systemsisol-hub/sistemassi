...
class _MainNavigationState extends State<MainNavigation> {
  ...
  List<Map<String, dynamic>> get _availablePages {
    ...
    // VENTAS: lo de Sisol, el chat público de sisol.com.mx. `show_ventas` para ver, `edit_ventas`
    // para capturar y configurar; la base aplica lo mismo con RLS.
    //
    // Los iconos son glifos que YA usa la aplicación (ver el comentario de SOL arriba): uno nuevo
